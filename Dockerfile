...
ADD --keep-git-dir=true --link gitlab.com/flightgear/fgmeta.git /flightgear/script/fgmeta
...
ADD --link gitlab.com/flightgear/simgear.git#release/${branch_end} /dev/null

ADD --link gitlab.com/flightgear/flightgear.git#release/${branch_end} /dev/null

ADD --link gitlab.com/flightgear/fgdata.git#release/${branch_end} /dev/null

ADD --link gitlab.com/flightgear/openscenegraph.git#release/2024-build /dev/null
